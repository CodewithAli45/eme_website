...
import completedProjects from "@/data/completedProject.json";
import { FaSearch, FaMapMarkerAlt, FaUserTie, FaCheckDouble } from "react-icons/fa";
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-4">
          ...
          <p className="text-slate-400 text-sm sm:text-base font-light max-w-xl mx-auto pt-2">
            Explore our rich legacy of successfully delivered projects, reflecting engineering excellence and timely turnkey execution.
          </p>
        </div>
        ...
        <div className="max-w-md mx-auto mb-12 relative">
          ...
          <input
            type="text"
            placeholder="Search completed works, clients..."
            value={searchTerm}
        ...
        {filteredProjects.length > 0 ? (
          ...
          <div className="text-center py-16 rounded-2xl border border-dashed border-slate-800 bg-slate-900/20 max-w-lg mx-auto">
            <p className="text-slate-500">No completed projects found matching &ldquo;{searchTerm}&rdquo;.</p>
          </div>
        )}
